  ...
  return (
    <>
      {(size === EResize.M || size === EResize.T) && (
        <>
          <div
            className={`MOB-NOTIFICATION-BAR h-24 px-5 animate-popIn w-full sticky top-0`}
          >
          ...
          <div
            className={`MOB-NAVIGATION-BAR bottom-0 h-24 bg-white border rounded-t-3xl animate-popIn ${baseLayoutStyles}`}
          >
      ...
      {size === EResize.D && (
        <div
          className={`top-0 h-16 border-2 border-secondary-200 ${baseLayoutStyles}`}
        >
